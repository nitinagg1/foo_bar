...
/**
 * Created by lenovo on 4/10/14.
 */
public class BounceCoordinates extends Activity
{
    float TouchX,TouchY;
    ...
    ImageView touchView;
    Bitmap test;
    public static float bouncepointX, bouncepointY;
    @Override
    ...
    public void NoteServingPosition(View view)
    {
        bouncepointX=TouchX;
        bouncepointY=TouchY;
        Intent intent= new Intent(this,DisplaySpeed.class);
